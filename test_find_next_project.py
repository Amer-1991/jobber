...
async def find_next_project():
    ...
    try:
        ...
        # Step 3: Find available projects
        print("🔍 Step 3: Finding available projects...")
        
        # Wait for projects to load
        await asyncio.sleep(5)
        
        # Find all project links directly
        ...
        # Step 4: Check each project until we find one we can submit to
        print("🔍 Step 4: Checking projects for availability...")
        ...
        while page_number <= max_pages:
            ...
            if i == len(project_links) - 1:  # Last project on this page
                ...
                if next_page_button:
                    ...
                    if not is_disabled:
                        ...
                        await asyncio.sleep(3)
                        page_number += 1
                        break  # Break out of project loop to start new page
                    else:
